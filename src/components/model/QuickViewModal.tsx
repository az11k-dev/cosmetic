                                ...
                                <Col md={7} sm={12}>
                                    <div className="quickview-pro-content">
                                        <h5 className="gi-quick-title">
                                            ...
                                            <Link
                                                to="/product-left-sidebar"> {lang === "ru" ? data?.name?.ru : data?.name?.uz}</Link>
                                        </h5>
                                        ...
                                        <div className="gi-quickview-price">
                                            <span
                                                className="new-price">{data?.price.toLocaleString("en-US")} so'm</span>
                                            <span
                                                className="old-price">{data?.old_price.toLocaleString("en-US")} so'm</span>
                                        </div>
