        ...
        <Row className="m-b-minus-24px">
          <Col lg={12}>
            <div className="tab-content">
              ...
              >
                <Row>
                  <FashionProductItem statekey="fashiontwoall" />
                </Row>
              </Fade>
              </TabPanel>
              {/* <!-- 1st Product tab end -->*/}
              ...
              >
                <Row>
                  <FashionProductItem statekey="fashiontwoclothes" />
                </Row>
              </Fade>
              </TabPanel>
              {/* <!-- 2nd Product tab end -->*/}
              ...
              >
                <Row>
                  <FashionProductItem statekey="fashiontwofootwear" />
                </Row>
              </Fade>
              </TabPanel>
              {/* <!-- 3rd Product tab end -->*/}
              ...
              >
                <Row>
                  <FashionProductItem statekey="fashiontwoaccessories" />
                </Row>
              </Fade>
              </TabPanel>
              {/* <!-- 4th Product tab end --> */}
