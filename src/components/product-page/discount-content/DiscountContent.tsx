      ...
      <div className={`gi-accordion style-1 gi-single-pro-tab-content`}>
        ...
        >
          ...
          {activeAccordion === 0 && (
            ...
            >
              <div className="gi-accordion-body d-block">                
        ...
        >
          ...
          <motion.div          
            ...
            transition={{ duration: 0.3, ease: 'easeInOut' }}
          >
            <div className="gi-accordion-body p-b-0 d-block">
                  ...
                  <div className="row">
                    ...
                    {!login ? (
                      <div className="container">
                        <p>
                          Please <Link to="/login">login</Link> or <Link to="/register">register</Link> to review the product.
                        </p>
                      </div>
                    ) : (
