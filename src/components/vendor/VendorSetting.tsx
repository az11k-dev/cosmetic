...
import { VendorData } from "@/types/data.types";

const VendorSetting = () => {
  const [userData, setUserData] = useState<VendorData | null>(null);
                      ...
                      <p>
                        {userData?.description ? (
                          ...
                          <>
                            ...
                            <Link to={"/vendor-setting-edit"}>this link</Link>
                          </>
                        )}
                      </p>
                    </div>
