...
import { Testimonials as TestimonialInterface } from "@/types/data.types";

const Testimonials = () => {
  const { data, error } = useSliceData('testimonials');
            ...
            <Col md={12}>
              <div className="testim-bg p-tb-80">
                ...
                <div className="gi-test-outer gi-test-section">
                  ...
                  >
                    {getData().map((item: TestimonialInterface, index: number) => (
